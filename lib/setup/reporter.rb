...
module Setup
  ...
  # A reporter collects events generated by tasks.
  ...
  class Reporter
    ...
    # @oaram op [symbol] the type of an operation that just started.
  ...
  class LoggerReporter < Reporter
    ...
    # has a description ({Task#description}) logs a message about an event.
    # @oaram (see Reporter#start)
